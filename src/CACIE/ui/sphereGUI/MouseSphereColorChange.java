...
public class MouseSphereColorChange extends MouseBehavior {
    ...
    PickSphereColorChangeBehavior ptb;
     ...
     */
    public MouseSphereColorChange(TransformGroup transformGroup) {
     ...
     * @param flags
     */
    public MouseSphereColorChange(PickSphereColorChangeBehavior pt, int flags, SphereProperties sps) {
	super(flags);
	this.ptb = pt;
	m_sps = sps;
     ...
     * @since Java 3D 1.2.1
     */
    public MouseSphereColorChange(Component c) {
	super(c, 0);
    }
     ...
     * @since Java 3D 1.2.1
     */
    public MouseSphereColorChange(Component c, TransformGroup transformGroup) {
     ...
     * @since Java 3D 1.2.1
     */
    public MouseSphereColorChange(Component c, int flags) {
	super(c, flags);
    }
