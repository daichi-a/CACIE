...
public class MouseIndividualDynamicColorChange extends MouseBehavior {
    ...
    PickIndividualDynamicColorChangeBehavior pdb;
     ...
     */
    public MouseIndividualDynamicColorChange(TransformGroup transformGroup) {
     ...
     */
    public MouseIndividualDynamicColorChange(){
	super(0);
    }
     ...
     * @param flags
     */
    public MouseIndividualDynamicColorChange(PickIndividualDynamicColorChangeBehavior pt, int flags, Sphere3D cd) {
	super(flags);
	sphere = cd;
	this.pdb = pt;
     ...
     * @since Java 3D 1.2.1
     */
    public MouseIndividualDynamicColorChange(Component c) {
	super(c, 0);
     ...
     * @since Java 3D 1.2.1
     */
    public MouseIndividualDynamicColorChange(Component c, TransformGroup transformGroup) {
     ...
     * @since Java 3D 1.2.1
     */
    public MouseIndividualDynamicColorChange(Component c, int flags) {
	super(c, flags);
    }
    
    public MouseIndividualDynamicColorChange(PickIndividualDynamicColorChangeBehavior pt, int flags) {
    	super(flags);
    	this.pdb = pt;
    	this.wrs3 = pt.getWrapSpheres3D();
        sind1 = new SphereIndividual();
...
//	    	for(int i = 0; i < 2; i++){
//    		sphere.colorChangeUpdate();
//    	}

//	    	sind1 = (SphereIndividual) pdb.getCurrentTG().getUserData();
//	    	System.out.println("Sind Blink_flag is " + sind1.getBlinkFlag());
//	    	if(sind1.getBlinkFlag()){
//	    	sphere.blinkingUpdate();
...
//			sind1 = (SphereIndividual) pdb.getCurrentTG().getUserData();
//			sind2.setSphere(sind1);
//			sind2.setBlinkFlag(true);
//			pdb.getCurrentTG().setUserData(sind2);
//			System.out.println("sphere: " + sind2.getIndex() + 
//					": flag: " + sind2.getBlinkFlag());
//		    if (invert) {
