...
public class MouseLineRotate extends MouseBehavior {
     ...
     */
    public MouseLineRotate(TransformGroup transformGroup) {
     ...
     */
    public MouseLineRotate(int flags) {
	super(flags);
    }
     ...
     * @since Java 3D 1.2.1
     */
    public MouseLineRotate(Component c) {
	super(c, 0);
    }
     ...
     * @since Java 3D 1.2.1
     */
    public MouseLineRotate(Component c, TransformGroup transformGroup) {
     ...
     * @since Java 3D 1.2.1
     */
    public MouseLineRotate(Component c, int flags) {
	super(c, flags);
    }
